...
\item The \gls{back end} classifies the initial column data
\item The \gls{back end} classifies the rest of the data based on past data columns and previous data fed through the system
...
\end{packed_enumerate}\\
\hline
Exceptions:&1.0.E.1 System loses connection to \gls{front end}(at step 1)\\
