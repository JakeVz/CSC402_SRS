...
{ name=Firebase,
  description={Firebase provides a realtime database and backend as a service. The service provides application developers an API that allows application data to be synchronized across clients and stored on Firebase's cloud.},
  sort={0}
  }
...
\hline
Spencer Schurk&Octover 24, 2018&Section 1 revisions&2.0\\
\hline
&&&\\
\hline
\end{tabular}
